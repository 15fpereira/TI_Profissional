...
# Após a configuração acessar a URL: http://ti-pro.intra/cgi-bin/awstats.pl?config=ti-pro.intra
		...
		then
			if [ "$KERNEL" == "4.4" ]
				then
					 ...
					 echo -e "Atualizando o arquivo awstats.ti-pro.intra.conf, aguarde..."
					 #Atualizando o arquivo de configuração personalizado do awstats
					 cp -v conf/awstats.ti-pro.intra.conf /etc/awstats/awstats.ti-pro.intra.conf >> $LOG
					 echo -e "Arquivo atualizado com sucesso!!!, continuando o script..."
					 sleep 2
					 echo
					 ...
					 echo -e "Editando o arquivo awstats.ti-pro.intra.conf, pressione <Enter> para continuar"
					 read
					 
					 #Editando o arquivo awstats.ti-pro.intra.conf
					 vim /etc/awstats/awstats.ti-pro.intra.conf
					 ...
					 /usr/lib/cgi-bin/awstats.pl -config=ti-pro.intra -update >> $LOG
