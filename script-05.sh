		...
		then
			if [ "$KERNEL" == "4.4" ]
				then		
					 ...
					 echo
					 echo -e "1 - Configurando as opções de Rede"
					 echo -e "2 - Configuração do arquivo interfaces"
					 echo -e "3 - Configuração do Serviço de SSHD"
					 echo -e "4 - Configuração dos arquivos hosts.allow e hosts.deny"
					 echo -e "5 - Configuração do Serviço de DHCPD"
					 echo
					 echo -e "Aguarde..."
					 echo
