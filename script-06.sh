...
#
# --realm=TI-PRO.INTRA – É onde setamos o domínio completo, no caso prefixo mais sufixo, obrigatório ser em MAIUSCULA;
#
# --domain=TI-PRO – Nessa opção, devemos setar apenas o prefixo do domínio, obrigatório ser em MAIUSCULA;
#
# --dns-backend=BIND9_DLZ – Por padrão SAMBA 4 utiliza o seu próprio DNS. Essa opção força o SSAMBA 4 utilizar o Bind como DNS 
# Backend.
#
# --adminpass=’pro@2020’ – Aqui configuramos a senha do usuário “Administrator”, que será o administrador do sistema.
#
