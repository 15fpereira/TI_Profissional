		...
		then
			if [ "$KERNEL" == "4.4" ]
				then
					 ...
					 echo
					 echo -e "1 - Quantida de portas padrão que devem ser listadas no servidor `hostname`: >=33 (portas)"
					 echo -e "2 - Após todos os serviços instalados e configurados o número de portas aumenta para >=36 (portas)"
					 echo -e "3 - Caso o número de portas seja diferente, verificar os status dos serviços de rede"
					 echo -e "4 - Rodar esse script novamente no final de todas as configurações do servidor"
					 echo
